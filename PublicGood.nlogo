...
to monte-carlo
  repeat L * L [
    ...
    ; cambio la strategia di x con probabilità q
...
to test-neighbors
  ...
  print (word "Turtle X: " X ", Vicino su: " neighbor-up ", Vicino giù: " neighbor-down ", Vicino a sinistra: " neighbor-left ", Vicino a destra: " neighbor-right)
